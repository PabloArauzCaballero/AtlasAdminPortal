...
- [ ] `NEXT_PUBLIC_API_BASE_URL` apunta al API interno correcto. — depende del despliegue; en local apunta a `:3005` y funciona.
...
- [ ] Stress QA está bloqueado en producción salvo política explícita. — política de despliegue.
