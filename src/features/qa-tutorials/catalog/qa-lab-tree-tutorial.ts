 ...
 * el flujo declarado y después cómo leer el lienzo. Los paneles que sólo
 * existen tras un clic (leyenda, ficha) se piden al usuario con su acción.
 */
export const decisionTreeTutorial: TutorialDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      validation: {
        hint: "pulsa la pestaña «Árbol de decisión» (la tercera, resaltada arriba).",
      },
    },
    {
      id: "stages",
      ...
      position: "right",
      nextRoute: "/internal/qa/lab?tab=arbol",
      waitForElement: true,
    },
    {
      id: "steps",
    ...
    {
      id: "legend-open",
      target: "workflow-legend-toggle",
      title: "Abre la leyenda",
      content:
        "Las flechas del dibujo tienen colores con significado. La leyenda los explica; se abre con el botón resaltado.",
      position: "left",
      requiredAction: {
        type: "element-appears",
        targetId: "workflow-legend",
      },
      validation: { hint: "pulsa el botón «Cómo leer el flujo» resaltado." },
      optional: true,
    },
    {
      id: "edges",
      ...
      content:
        "Aquí está el árbol de decisión: cada flecha lleva la condición bajo la que se toma.\n\nVerde «si sale bien», roja «si falla», azul «según el estado del cliente», ámbar «condicional». Las moradas punteadas son dependencias: qué paso exige que otro esté hecho antes.",
      example:
    ...
    },
    {
      id: "select",
      target: "workflow-graph",
      title: "Selecciona algo del dibujo",
      content:
        "Cada etapa, paso o flecha tiene una ficha con lo que el catálogo declara. Haz clic sobre cualquier nodo para abrirla.",
      position: "right",
      requiredAction: {
        type: "element-appears",
        targetId: "workflow-detail",
      },
      validation: {
        hint: "haz clic en cualquier etapa o paso del dibujo resaltado.",
      },
      optional: true,
    },
    {
