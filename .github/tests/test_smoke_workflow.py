...
out.write_text(json.dumps({'docker_compose_domains': json.dumps({'portal': {'domain': 'https://portal.example.test:5273'}})}))
...
''')
    ...
    for name, extra, expected, url in [
        ('coolify-domain', {}, 0, 'https://portal.example.test:5273'),
